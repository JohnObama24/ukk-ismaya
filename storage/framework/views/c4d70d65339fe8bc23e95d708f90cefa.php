...
<div class="max-w-4xl mx-auto space-y-8 pb-10">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-[#1A1C1E]">Add New product</h2>
            <p class="text-sm text-gray-400 mt-1 font-medium italic">Create a new entry for your inventory.</p>
        </div>
        <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-2 px-4 py-2 text-gray-500 hover:text-orange-600 font-bold transition">
        ...
        <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="e.g. ushio noa keychain">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" id="price" value="<?php echo e(old('price')); ?>" required class="block w-full pl-10 pr-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="stock" id="stock" value="<?php echo e(old('stock', 0)); ?>" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" name="discount" id="discount" value="<?php echo e(old('discount', 0)); ?>" min="0" max="100" class="block w-full pr-10 pl-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="4" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="Tell us more about this snack..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Image Upload -->
            <div class="space-y-2">
                <label class="text-xs font-extrabold text-gray-400 uppercase tracking-widest pl-1">figure Image</label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project-UKK\resources\views/admin/products/create.blade.php ENDPATH**/ ?>