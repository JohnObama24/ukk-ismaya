    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
            ...
            <aside class="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
                <nav class="space-y-1">
                    <a href="<?php echo e(route('profile.index')); ?>" class="bg-blue-50 text-blue-700 hover:bg-white group rounded-md px-3 py-2 flex items-center text-sm font-medium border-l-4 border-blue-600 shadow-sm">
                        <!-- Icon -->
                    ...
                    <a href="<?php echo e(route('orders.index')); ?>" class="text-gray-900 hover:bg-gray-50 hover:text-gray-900 group rounded-md px-3 py-2 flex items-center text-sm font-medium">
                        <!-- Icon -->
                        ...
                        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $user->name)); ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project-UKK\resources\views/profile/index.blade.php ENDPATH**/ ?>