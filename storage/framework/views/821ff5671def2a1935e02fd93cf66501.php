...
<body class="bg-gray-100">
    ...
    <div class="no-print fixed top-4 right-4 flex space-x-2">
        ...
        <a href="<?php echo e(route('orders.index')); ?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-blue-600 text-white px-8 py-6">
            <div class="flex justify-between items-center">
                ...
                <div class="text-right">
                    <p class="text-2xl font-bold">#<?php echo e($order->order_number); ?></p>
                    <p class="text-blue-200"><?php echo e($order->created_at->format('F d, Y')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="px-8 py-6 border-b border-gray-200">
            <div class="grid grid-cols-2 gap-8">
                <div>
                    ...
                    <p class="mt-2 text-gray-900 font-medium"><?php echo e(auth()->user()->name); ?></p>
                ...
                <div class="text-right">
                    ...
                    <p class="mt-2">
                        ...
                        <?php else: ?>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800"><?php echo e(ucfirst($order->status)); ?></span>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100">
                        <td class="py-4 text-gray-900"><?php echo e($item->product ? $item->product->name : 'Product Unavailable'); ?></td>
                        <td class="py-4 text-center text-gray-600"><?php echo e($item->quantity); ?></td>
                        <td class="py-4 text-right text-gray-600">$<?php echo e(number_format($item->price, 2)); ?></td>
                        <td class="py-4 text-right text-gray-900 font-medium">$<?php echo e(number_format($item->price * $item->quantity, 2)); ?></td>
                    </tr>
            ...
            <div class="flex justify-end">
                <div class="w-64">
                    <div class="flex justify-between py-2 border-t-2 border-gray-300">
                        ...
                        <span class="text-lg font-bold text-blue-600">$<?php echo e(number_format($order->total_price, 2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\Projek-UKK\resources\views/orders/invoice.blade.php ENDPATH**/ ?>