                ...
                <div class="mt-6">
                    ...
                    <div class="mt-10 p-4 bg-orange-50 border border-orange-200 rounded-xl">
                        ...
                        <div class="mt-4 flex space-x-3">
                            <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="inline-flex items-center px-4 py-2 bg-orange-600 border border-transparent rounded-lg font-bold text-white hover:bg-orange-700 transition shadow-sm text-sm">
                                Ubah Produk Ini
                            </a>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg font-bold text-gray-700 bg-white hover:bg-gray-50 transition shadow-sm text-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/products/show.blade.php ENDPATH**/ ?>