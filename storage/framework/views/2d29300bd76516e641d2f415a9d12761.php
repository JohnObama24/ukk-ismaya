            ...
            <form action="<?php echo e(route('password.email')); ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    >
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <button
                        type="submit"
                        class="w-full py-4 rounded-xl text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 transition"
                    >
                        Reset Password
                    </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>