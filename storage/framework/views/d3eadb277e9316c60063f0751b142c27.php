            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-[#F8F9FA] transition group">
                        ...
                        <td class="px-8 py-5">
                            <div class="font-bold text-[#1A1C1E] text-sm"><?php echo e($order->user->name ?? 'Guest'); ?></div>
                        ...
                        <td class="px-8 py-5 text-center">
                            ...
                            ?>
                            <span class="px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest <?php echo e($class); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/admin/orders.blade.php ENDPATH**/ ?>