...
<div class="space-y-8 pb-10">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8 border-b border-gray-50 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.orders')); ?>" class="text-sm font-extrabold text-orange-600 hover:text-orange-700 flex items-center gap-1 group">
                View All 
                    ...
                    <tr class="hover:bg-[#F8F9FA] transition group">
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-xl flex items-center justify-center <?php echo e($order->status == 'pending' ? 'bg-amber-50 text-amber-600' : 'bg-orange-50 text-orange-600'); ?>">
                                     <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                                    </svg>
                                </div>
                                <span class="font-bold text-[#1A1C1E]">New Order #<?php echo e($order->order_number); ?></span>
                            </div>
                        </td>
                        <td class="px-8 py-5">
                            <span class="text-sm font-bold text-gray-500"><?php echo e($order->user->name ?? 'Guest'); ?></span>
                        </td>
                        ...
                        <td class="px-8 py-5">
                            <div class="flex justify-center">
                                ...
                                ?>
                                <span class="px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest <?php echo e($statusClasses[$order->status] ?? 'bg-gray-50 text-gray-500'); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>