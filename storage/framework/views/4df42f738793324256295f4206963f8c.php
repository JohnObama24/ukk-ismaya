                    ...
                    <tr class="hover:bg-[#F8F9FA] transition group">
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-3">
                                ...
                                <h5 class="text-sm font-extrabold text-[#1A1C1E]"><?php echo e($customer->name); ?></h5>
                            </div>
                        </td>
                        <td class="px-8 py-5">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/admin/customers.blade.php ENDPATH**/ ?>