        ...
        <div class="mt-6 lg:grid lg:grid-cols-4 lg:gap-x-8">
            ...
            <div class="hidden lg:block space-y-4">
                ...
                <ul class="space-y-3 pb-6 border-b border-gray-200 text-sm font-medium text-gray-900">
                    <li>
                        <a href="<?php echo e(route('products.index')); ?>" class="<?php if(!request('category')): ?> text-orange-600 <?php else: ?> text-gray-500 <?php endif; ?> hover:text-orange-600">
                            Semua Kategori
                        </a>
                    </li>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>" class="<?php if(request('category') == $category->slug): ?> text-orange-600 <?php else: ?> text-gray-500 <?php endif; ?> hover:text-orange-600">
                    ...
                    <div class="group relative flex flex-col bg-white hover:shadow-lg transition shadow-sm border border-transparent hover:border-orange-500 duration-200">
                        ...
                        <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="relative aspect-square bg-white block">
                            <div class="absolute inset-0 flex items-center justify-center">
                                 <!-- ... image placeholder ... -->
                                 <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-contain text-xs text-gray-400">
                            </div>
                            <!-- Badge -->
                            <?php if($loop->index == 0): ?>
                        ...
                        <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="absolute top-0 right-0 p-2 bg-orange-600 text-white rounded-bl-lg hover:bg-orange-700 transition z-20 shadow-sm" title="Edit Produk">
                        ...
                        <div class="p-2 flex flex-col flex-1">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="flex items-center justify-between">
                                    <p class="text-sm font-semibold text-orange-600">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/products/index.blade.php ENDPATH**/ ?>