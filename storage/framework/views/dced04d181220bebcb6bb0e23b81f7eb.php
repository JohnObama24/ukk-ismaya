                    ...
                    <tr class="group hover:bg-[#F8F9FA] transition">
                        <td class="px-8 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <img src="<?php echo e(asset('storage/' . $product->image)); ?>" class="w-10 h-10 rounded-xl object-cover" alt="">
                                <?php else: ?>
                        ...
                        <td class="px-8 py-5 text-center">
                            <?php if($product->stock < 10): ?>
                                <span class="px-3 py-1 bg-red-50 text-red-500 rounded-lg text-[10px] font-extrabold uppercase tracking-widest border border-red-100">Critical: <?php echo e($product->stock); ?></span>
                            <?php else: ?>
                                <span class="px-3 py-1 bg-orange-50 text-orange-500 rounded-lg text-[10px] font-extrabold uppercase tracking-widest border border-orange-100">Ok: <?php echo e($product->stock); ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Projek-UKK\resources\views/admin/reports.blade.php ENDPATH**/ ?>