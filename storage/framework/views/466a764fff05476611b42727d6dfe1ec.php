...
<div class="max-w-4xl mx-auto space-y-8 pb-10">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-[#1A1C1E]">Edit product: <?php echo e($product->name); ?></h2>
        ...
        <form action="<?php echo e(route('admin.products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $product->name)); ?>" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="e.g. Spicy Cassava Chips">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" id="price" value="<?php echo e(old('price', $product->price)); ?>" required class="block w-full pl-10 pr-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="stock" id="stock" value="<?php echo e(old('stock', $product->stock)); ?>" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" name="discount" id="discount" value="<?php echo e(old('discount', $product->discount)); ?>" min="0" max="100" class="block w-full pr-10 pl-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="4" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="Tell us more about this snack..."><?php echo e(old('description', $product->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project-UKK\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>