...
<div class="space-y-8 pb-10">
    ...
    <div class="flex flex-wrap items-start gap-3 justify-between">
        <div>
            <h2 class="text-xl sm:text-2xl font-extrabold text-[#1A1C1E]">Order Management</h2>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-[#F8F9FA]">
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400">Order Info</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400">Customer</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400 text-right">Total Amount</th>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Project-UKK\resources\views/admin/orders.blade.php ENDPATH**/ ?>