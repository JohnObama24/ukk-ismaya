...
<div class="space-y-8 pb-10">
    ...
    <div class="flex flex-wrap items-start gap-3 justify-between">
        <div>
            <h2 class="text-xl sm:text-2xl font-extrabold text-[#1A1C1E]">Dashboard Overview</h2>
            <p class="text-sm text-gray-400 mt-1 font-medium italic">Welcome back! Here's what's happening today.</p>
        </div>
        <div class="flex items-center gap-3">
            <span class="flex items-center gap-2 px-3 sm:px-4 py-2 bg-white border border-gray-100 rounded-xl text-xs sm:text-sm font-bold text-gray-500 shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            <div class="flex flex-wrap items-center gap-3 justify-between mb-6 lg:mb-8">
                <div>
                    <h4 class="text-lg sm:text-xl font-extrabold text-[#1A1C1E]">Sales Trend</h4>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-4 sm:px-6 lg:px-8 py-5 lg:py-6 border-b border-gray-50 flex flex-wrap items-center gap-3 justify-between">
            <div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-[#F8F9FA]">
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400">Event</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400">Customer</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400 text-right">Amount</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400 text-center">Status</th>
                        <th class="px-4 sm:px-8 py-4 text-[10px] font-extrabold uppercase tracking-widest text-gray-400 text-right">Time</th>
                    </tr>
                </thead>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Project-UKK\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>