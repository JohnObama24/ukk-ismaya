...
<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
    <div class="relative rounded-3xl overflow-hidden shadow-2xl h-[400px] md:h-[500px]">
        ...
        <!-- Overlay -->
        <div class="absolute inset-0 bg-gradient-to-r from-black/80 md:from-black/60 to-transparent flex items-center">
            <div class="max-w-xl px-6 md:px-12">
                <div class="inline-block bg-orange-600 text-white text-[10px] font-bold px-2 py-1 rounded mb-4 md:mb-4 tracking-widest uppercase">
                    KhilafStore EXCLUSIVE
                </div>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white leading-tight mb-4 md:mb-6">
                    Brand new <br>
                    <span class="text-orange-400">Persona 5:</span> <br>
                    action figure
                </h1>
                <p class="text-base md:text-lg text-gray-200 mb-8 max-w-md">
                    Discover the world's most biggest merch store
                </p>
                <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
                    <a href="<?php echo e(route('products.index')); ?>" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 md:py-4 px-6 md:px-8 rounded-xl transition shadow-lg text-center">
                        Shop Now
                    </a>
                    <a href="#" class="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 font-bold py-3 md:py-4 px-6 md:px-8 rounded-xl transition text-center">
                        View Lookbook
                    </a>
                </div>
            </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
    <div class="bg-orange-600 rounded-[2.5rem] overflow-hidden relative p-8 md:p-12 lg:p-20 shadow-xl">
        <div class="grid lg:grid-cols-2 items-center gap-8 lg:gap-12 relative z-10">
            <div>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-4 lg:mb-6 leading-tight">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project-UKK\resources\views/home.blade.php ENDPATH**/ ?>