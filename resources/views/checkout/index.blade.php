                    ...
                    <ul role="list" class="divide-y divide-gray-200">
                        ...
                        <li class="p-6 flex items-center">
                            ...
                            <div class="text-right">
                                <p class="text-sm text-gray-500">Rp {{ number_format($details['price'], 0, ',', '.') }}</p>
                                <p class="text-sm text-gray-500">x {{ $details['quantity'] }}</p>
                                <p class="text-base font-bold text-gray-900 mt-1">Rp {{ number_format($details['price'] * $details['quantity'], 0, ',', '.') }}</p>
                            </div>
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="bg-white shadow sm:rounded-lg p-6 sticky top-6">
                    ...
                    <dl class="space-y-4 text-sm text-gray-600">
                        ...
                        <div class="border-t border-gray-200 pt-4 flex items-center justify-between">
                            ...
                            <dd class="text-xl font-extrabold text-orange-600">Rp {{ number_format($total + 16000, 0, ',', '.') }}</dd>
                        </div>
                    </dl>
