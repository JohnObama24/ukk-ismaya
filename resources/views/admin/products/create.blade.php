        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="e.g. ushio noa keychain">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price') }}" required class="block w-full pl-10 pr-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" name="stock" id="stock" value="{{ old('stock', 0) }}" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" name="discount" id="discount" value="{{ old('discount', 0) }}" min="0" max="100" class="block w-full pr-10 pl-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="0">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="4" required class="block w-full px-4 py-3 rounded-xl border-gray-300 bg-[#F8F9FA] focus:ring-2 focus:ring-orange-500 focus:bg-white transition" placeholder="Tell us more about this snack...">{{ old('description') }}</textarea>
