...
<div class="bg-gray-100 min-h-screen pb-24">
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-4 shadow-sm rounded-lg grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div class="col-span-12 md:col-span-6 flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="md:hidden mt-2 font-bold text-orange-500">Rp {{ number_format($details['price'], 0, ',', '.') }}</div>
                    </div>
                </div>
                ...
                <div class="col-span-12 md:col-span-2 flex justify-center items-center">
                    <div class="flex items-center border border-gray-300 rounded-sm">
                        ...
                        <input type="text" value="{{ $details['quantity'] }}" class="w-12 text-center border-none focus:ring-0 text-sm p-1" readonly>
                        <button disabled class="px-3 py-1 text-gray-600 hover:bg-gray-100 cursor-not-allowed">+</button>
                    </div>
                </div>
                ...
                <div class="col-span-12 md:col-span-1 text-center flex md:block justify-end">
                    <a href="{{ route('cart.remove', $id) }}" class="text-gray-500 hover:text-red-500 text-sm font-medium">Hapus</a>
                </div>
            </div>
            @endforeach
        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-start">
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-600 text-sm">Pilih Semua ({{ count($cart) }})</span>
                    </div>
                ...
                <div class="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end">
                    <div class="flex items-center gap-2">
                        <span class="text-gray-600 text-sm">Total ({{ count($cart) }} produk):</span>
                        <span class="text-xl font-bold text-orange-500">Rp {{ number_format($total, 0, ',', '.') }}</span>
                    </div>
                    <a href="{{ route('checkout.index') }}" class="bg-orange-500 text-white font-bold py-3 px-10 rounded-sm hover:bg-orange-600 transition shadow-lg">
                        Checkout
                    </a>
                </div>
            </div>
        ...
        <div class="text-center py-24 bg-white shadow sm:rounded-lg">
            ...
            <div class="mt-8">
                <a href="{{ route('products.index') }}" class="inline-flex items-center px-8 py-3 border border-transparent shadow-sm text-base font-bold rounded-md text-white bg-orange-500 hover:bg-orange-600 transition">
                    Belanja Sekarang
                </a>
            </div>
        </div>
